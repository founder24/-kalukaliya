...
- **Cost & runway model (Task #550, 2026-05-07):** Phased credit-runway memo at [`artifacts/syrabit/docs/infra/credit-runway-cost-model.md`](artifacts/syrabit/docs/infra/credit-runway-cost-model.md). Headline credit-on monthly burn per phase: **P1 (1k–5k DAU) = $60–$90**, **P2 (5k–10k DAU) = $80–$100 (at the #549 cap)**, **P3 (10k–50k DAU) = $300–$500 (requires `# COST-CAP-OVERRIDE` cap raise)**, **P4 (50k–100k DAU) = $700–$1,000 (revenue-positive, credits become per-incident cushion)**. Coexists with Task #549 founder-locks: the $100 cap, the workers_ai chat head, the voice paywall, and the 60/80/95 % degradation ladder are **superior** to anything in the memo — if a memo number ever requires breaching one of those locks, the lock wins and the memo must be re-derived. Quarterly review cadence; next review **2026-08-07**.
