...
- [Chat dispatch (#554, reaffirmed #559)](docs/architecture/decisions.md#chat-dispatch-task-554-2026-05-07-canonical-row-reaffirmed-by-task-559) — Strict 2-position English chain `vertex → workers_ai_llama32_3b` (flips at ≤90d runway); Assamese is `[sarvam, workers_ai_indic]`; Azure OpenAI fully retired.
...
- [Observability (#558)](docs/architecture/decisions.md#observability-task-558-2026-05-07) — Errors-only Sentry Developer free tier + OTEL → GCP Cloud Trace as sole tracing exporter; Sentry Performance retired.
