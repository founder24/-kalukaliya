...
# Task #6 (2026-05-09) — `_RAILWAY_AUDIT_BLOCK_REMOVED_PLACEHOLDER`
# (a 200-line tombstone retained from the Task #336 Railway → ACA cutover)
# was deleted in the backend dead-code purge. The block had been a no-op
# `return None` since #336; secrets topology is documented in
# `infra/v4-locked-architecture.md` §6 and `docs/architecture/decisions.md`.
...
from routes.admin_corpus_assamese import router as admin_corpus_assamese_router  # Task #45
...
api.include_router(admin_corpus_assamese_router)  # Task #45
