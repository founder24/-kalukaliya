...
/**
 * Hook that handles claiming anonymous study data (notes, flashcards)
 * when a user signs in. Shows a one-time toast on success.
 */
export function useAnonSync(userId) {
  useEffect(() => {
    if (!userId) return;
