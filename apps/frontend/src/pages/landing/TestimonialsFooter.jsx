...
// Inline SVG icon components replacing removed lucide-react brand icons (removed in v1.16.0)
function Twitter({ className, size = 24, ...props }) {
  return (
    <svg
...
function Github({ className, size = 24, ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
