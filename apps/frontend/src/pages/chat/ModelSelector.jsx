...
// Student chat is generated by the Cloudflare Workers AI route. The label is
// intentionally product-facing; the Worker owns the concrete primary/fallback
// model selection so a saved client preference cannot bypass it.
const MODELS = [
  { value: 'workers-ai-fast', label: 'Syrabit AI', badge: '⚡ Fast' },
