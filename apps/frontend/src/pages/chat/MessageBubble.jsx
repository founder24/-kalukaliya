  ...
  return (
    ...
    >
      ...
      {!isUser && (
        ...
        <div className="w-full" style={{ color: 'hsl(var(--foreground))', WebkitTextFillColor: 'unset' }}>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs font-semibold text-muted-foreground">Syrabit AI</span>
          </div>
          <div className="w-full" style={msg.streaming ? { willChange: 'contents', contain: 'layout style' } : undefined}>
            {msg.streaming && !msg.content && !msg.translating && (
              <ThinkingIndicator subject={subject} scopedChapters={scopedChapters} chapterMatch={msg.wai_chapter_match || null} discoveryEvents={msg.discovery_events || []} lang={responseLang || 'en'} />
            )}
            {msg.translating && !msg.content && (
              <div className="flex items-center gap-2 py-2 text-sm text-muted-foreground animate-pulse">
                ...
                {responseLang === 'as' ? 'অসমীয়ালৈ অনুবাদ কৰিছো…' : 'Translating to Assamese…'}
              </div>
            )}
